...
Le script demarre le serveur local, ouvre un tunnel public, puis affiche une adresse de ce genre :

```text
wss://blue-river-12.loca.lt?room=LOCAL
```
...
```bash
node L3NetServer/server.js --port 7777 --host 0.0.0.0 --room LOCAL --max-players 4 --state-interval 33
```
